...
window.HOTSPOTS = [
  {
    x: 30.8, y: 44.5, n: 1,
    title: "Asignar medio de acceso:",
    text: "En este formulario se puede crear y asignar un medio de acceso de forma directa, se deben diligenciar todos los datos para una correcta creación."
  },
  {
    x: 65.5, y: 44.5, n: 2,
    title: "Medios de acceso:",
    text: "Este panel muestra los medios de acceso que actualmente tiene asignado el cliente, se tiene dos botones adicionales los cuales permiten editar y eliminar dicho medio de acceso. "
  },
...
window.BUTTONS = [
  ...
  {
    x: 53.7, y: 38.3, //Notificaciones
    label: "+",
    href: "https://wilvar88.github.io/SIR-Cuentas-Notificaciones/",
    target: "self",
    // Si quieres totalmente transparente, puedes usar la variante 'transparent'
    // (ojo: pone background transparente con !important)
    variant: "transparent",
